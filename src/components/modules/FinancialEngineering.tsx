...
import {
    ...
    RETIREMENT_SECTION_DETAILS,
    EXIT_TAX_SECTION_DETAILS,
    CASH_FLOW_SECTION_DETAILS,
    COMPLIANCE_SECTION_DETAILS,
    IMPORTANCE_COLORS,
    type FinancialTopicDetail
} from '../../data/financialDetails';
...
function TopicDetailModal({ topic, onClose }: { topic: FinancialTopicDetail; onClose: () => void }) {
    return (
        <div
            style={{
                position: 'fixed',
        ...
        >
            ...
            >
                ...
                <div style={{
                    ...
                    alignItems: 'flex-start',
                    background: IMPORTANCE_COLORS[topic.importance].bg,
                    ...
                    <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                        ...
                        <div>
                            ...
                            <div style={{
                                ...
                                fontSize: '12px',
                                fontWeight: '600',
                                background: IMPORTANCE_COLORS[topic.importance].color + '30',
                                color: IMPORTANCE_COLORS[topic.importance].color
                            }}>
                                <Shield size={12} />
                                {IMPORTANCE_COLORS[topic.importance].label}
                            </div>
                        </div>
                    </div>
                    <button
...
function TopicCard({ topic, onClick }: { topic: FinancialTopicDetail; onClick: () => void }) {
    return (
        <div
            ...
            style={{
                ...
                cursor: 'pointer',
                transition: 'all 0.3s ease',
                borderLeft: `4px solid ${IMPORTANCE_COLORS[topic.importance].color}`
            }}
            onMouseEnter={(e) => {
...
function RetirementStrategySection() {
    const [selectedTopic, setSelectedTopic] = useState<FinancialTopicDetail | null>(null);
    ...
    return (
        <div className="animate-fadeIn">
            {/* Expandable Topics */}
            <h2 style={{ fontSize: '22px', fontWeight: '700', marginBottom: '16px' }}>📚 Explore Retirement Topics</h2>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '20px', marginBottom: '40px' }}>
                {RETIREMENT_SECTION_DETAILS.map((topic) => (
                    <TopicCard
                        key={topic.id}
                        topic={topic}
...
function ExitTaxSection() {
    ...
    return (
        <div className="animate-fadeIn">
            {/* Expandable Topics */}
            <h2 style={{ fontSize: '22px', fontWeight: '700', marginBottom: '16px' }}>📚 Explore Exit Tax Topics</h2>
            <p style={{ color: 'var(--text-muted)', marginBottom: '24px', fontSize: '14px' }}>
                Click on any topic to view detailed information, action steps, and official sources.
            </p>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '20px', marginBottom: '40px' }}>
                {EXIT_TAX_SECTION_DETAILS.map((topic) => (
                    <TopicCard
                        key={topic.id}
                        topic={topic}
                        onClick={() => setSelectedTopic(topic)}
...
function OverviewSection() {
    ...
    return (
        <div className="animate-fadeIn">
            {/* Expandable Topics */}
            <h2 style={{ fontSize: '22px', fontWeight: '700', marginBottom: '16px' }}>📚 Explore Key Topics</h2>
            <p style={{ color: 'var(--text-muted)', marginBottom: '24px', fontSize: '14px' }}>
                Click on any topic to view detailed information, action steps, and official sources.
            </p>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '20px', marginBottom: '40px' }}>
                {OVERVIEW_SECTION_DETAILS.map((topic) => (
                    <TopicCard
                        key={topic.id}
                        topic={topic}
                        onClick={() => setSelectedTopic(topic)}
...
function FrameworksSection() {
    ...
    return (
        <div className="animate-fadeIn">
            {/* Expandable Topics */}
            <h2 style={{ fontSize: '22px', fontWeight: '700', marginBottom: '16px' }}>📚 Explore Cash Flow Topics</h2>
            <p style={{ color: 'var(--text-muted)', marginBottom: '24px', fontSize: '14px' }}>
                Click on any topic to view detailed information, action steps, and official sources.
            </p>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '20px', marginBottom: '40px' }}>
                {CASH_FLOW_SECTION_DETAILS.map((topic) => (
                    <TopicCard
                        key={topic.id}
                        topic={topic}
                        onClick={() => setSelectedTopic(topic)}
...
function ComplianceSection() {
    ...
    return (
        <div className="animate-fadeIn">
            {/* Expandable Topics */}
            <h2 style={{ fontSize: '22px', fontWeight: '700', marginBottom: '16px' }}>📚 Explore Compliance Topics</h2>
            <p style={{ color: 'var(--text-muted)', marginBottom: '24px', fontSize: '14px' }}>
                Click on any topic to view detailed information, action steps, and official sources.
            </p>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '20px', marginBottom: '40px' }}>
                {COMPLIANCE_SECTION_DETAILS.map((topic) => (
                    <TopicCard
                        key={topic.id}
                        topic={topic}
                        onClick={() => setSelectedTopic(topic)}
